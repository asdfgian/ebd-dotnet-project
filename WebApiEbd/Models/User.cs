...
public class User
{
    ...
    public ICollection<Movement> MovementCreatedByNavigation { get; set; } = new List<Movement>();

    [InverseProperty("UserDestination")]
    public ICollection<Movement> MovementUserDestination { get; set; } = new List<Movement>();

    [InverseProperty("UserOrigin")]
    public ICollection<Movement> MovementUserOrigin { get; set; } = new List<Movement>();
